...
//    private MarketScanScheduler scanner;
//    
//    @Mock
//    private CoinbaseClientFactory mockedCoinbaseClientFactory;
//	private CircuitBreakerRegistry mockedCircuitBreakerRegistry;
//
////	private volatile List<CoinScanResult> latestResults = Collections.emptyList();
//	private TradingOrchestrator mockedTradingOrchestrator;
//	@Mock
//	private CoinsRepository mockedCoinsRepository;
//
//    @BeforeEach
//    void setUp() {
...
//            scanner = new MarketScanScheduler(mockedCoinbaseClientFactory, mockedCircuitBreakerRegistry, mockedTradingOrchestrator, mockedCoinsRepository, tradeDecisionService);
//
